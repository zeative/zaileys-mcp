---
description: "Install zaileys-mcp, connect it to Claude Desktop or Cursor, scan the QR, and start driving WhatsApp from your AI agent."
---
...
<Tabs items={['Claude Desktop', 'Cursor', 'Any MCP client']}>
  <Tabs.Tab>
