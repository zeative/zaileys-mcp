---
description: "How zaileys-mcp keeps 60+ tools available without bloating the agent's context — progressive tool disclosure via a find_tools meta-tool and MCP's dynamic tool list."
---
